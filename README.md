...
# Statistics
Update of the following table: 2026-02-01 03:12 CEST

| Malicious IP addresses in full-\*                          | %       | Number of IPs |
| ---------------------------------------------------------- | ------- | ------------- |
| Present in 6 sources and more | 6.02 % | 30 460 |
| Present in 5 sources | 5.55 % | 28 086 |
| Present in 4 sources | 6.07 % | 30 696 |
| Present in 3 sources | 6.47 % | 32 736 |
| Present in 2 sources | 16.56 % | 83 688 |
| Present in 1 source | 59.29 % | 299 649 |
| Total | 100 % | 505 315 |

Update of the common IP table with the FortiGate ISDB Malicious-Malicious.Server: 2026-02-01 01:50 CEST
