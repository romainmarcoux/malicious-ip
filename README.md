...
# Statistics
Update of the following table: 2025-07-12 23:44 CEST

| Malicious IP addresses in full-\*                          | %       | Number of IPs |
| ---------------------------------------------------------- | ------- | ------------- |
| Present in 6 sources and more | 2.30 % | 18 197 |
| Present in 5 sources | 3.13 % | 24 776 |
| Present in 4 sources | 4.88 % | 38 643 |
| Present in 3 sources | 8.09 % | 64 056 |
| Present in 2 sources | 18.67 % | 147 689 |
| Present in 1 source | 62.91 % | 497 633 |
| Total | 100 % | 790 994 |

Update of the common IP table with the FortiGate ISDB Malicious-Malicious.Server: 2025-07-12 01:30 CEST

| FortiGate models                                           | full-\* IPs common with ISDB |
| ------------------------------------------------------------ | ----------- |
| 100F and below | 2.91 % |
| 200F and above | 18.13 % |
