...
# Statistics
Update of the following table: 2025-08-10 00:44 CEST

| Malicious IP addresses in full-\*                          | %       | Number of IPs |
| ---------------------------------------------------------- | ------- | ------------- |
| Present in 6 sources and more | 2.67 % | 20 318 |
| Present in 5 sources | 3.60 % | 27 401 |
| Present in 4 sources | 5.34 % | 40 590 |
| Present in 3 sources | 6.34 % | 48 144 |
| Present in 2 sources | 16.48 % | 125 113 |
| Present in 1 source | 65.54 % | 497 497 |
| Total | 100 % | 759 063 |

Update of the common IP table with the FortiGate ISDB Malicious-Malicious.Server: 2025-08-09 01:30 CEST

| FortiGate models                                           | full-\* IPs common with ISDB |
| ------------------------------------------------------------ | ----------- |
| 100F and below | 2.81 % |
| 200F and above | 17.40 % |
